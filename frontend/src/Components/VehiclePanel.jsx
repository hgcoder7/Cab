...
const VehiclePanel = (props) => {
  return (
    <div>
       <h5 className='p-1 text-center w-[93%] absolute top-0' onClick={()=>{props.setVehiclePanel(false)}}><i className=" text-3xl text-gray-300 ri-arrow-down-wide-fill"></i></h5>
        ...
        className="flex border-2 active:border-black rounded-xl mb-2 w-full p-3 items-center justify-between">
           ...
           <h2 className='font-semibold text-lg'>$192.34</h2>
        </div>
        <div onClick={()=>{props.setConfirmRidePanel(true)}} 
        className="flex border-2 active:border-black rounded-xl mb-2 w-full p-3 items-center justify-between">
           ...
           <h2 className='font-semibold text-lg'>$65.44</h2>
        </div>
        <div onClick={()=>{props.setConfirmRidePanel(true)}} 
        className="flex border-2 active:border-black rounded-xl mb-2 w-full p-3 items-center justify-between">
           ...
           <h2 className='font-semibold text-lg'>$118.73</h2>
        </div>
    </div>
  )
}
